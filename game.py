...
gametitle="Dungeons and Dragons- an interactive story game"
system("mode 110,30")
...
cls()
print ("Dungeons and Dragons- An interactive fiction game in python")
...
def create_character():
	...
	while character_race is None:
		race_choice = input("""
		Choose your character race from the list below by entering the relevent number:
		1 - Elf
		2 - Dwarf
	...
	while character_class is None:
		class_choice=input("""
		Choose your character class from the list below by entering the relevent number:
		1 - Warrior
		2 - Wizard
...
def create_character_skill_sheet():
	...
	- Magic, which you will use whenever you need to cast a spell or use/inspect a magical item or
...
def modify_skills():
	...
	print("To modify your skills, roll a six face die for each of your skills, and the game will add your")
...
def Scene_1():
	...
	while choice is None:
		user_input=input("""
	You have entered the Dungeons...
	It is dark, however thankfully your torch is lit and you can see upto 20 feet away from you.
	The stone walls are damp, the smell of the rats and orcs are strong.
...
def skill_check():
	...
	if roll+character_dexterity > 10:
		...
		The strange noise in the darkness continues, and it fells a lot closer now..""")
		input("Press Enter to continue...")
		combat()
	else:
		print("You are smashed by the rock.. You die. The game is over")
		input("Pres Enter to exit the game.")
...
def combat():
	...
	while orc[1] > 0 or character_life > 0:
		...
		print("Your rolled:"+str(char_roll))
